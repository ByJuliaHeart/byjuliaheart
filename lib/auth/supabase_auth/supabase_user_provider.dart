...
class GameJuliaHeartSupabaseUser extends BaseAuthUser {
  GameJuliaHeartSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> gameJuliaHeartSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = GameJuliaHeartSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
