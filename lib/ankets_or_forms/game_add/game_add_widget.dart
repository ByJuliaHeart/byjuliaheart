...
import 'game_add_model.dart';
export 'game_add_model.dart';

class GameAddWidget extends StatefulWidget {
  const GameAddWidget({super.key});

  @override
  State<GameAddWidget> createState() => _GameAddWidgetState();
}

class _GameAddWidgetState extends State<GameAddWidget>
    with TickerProviderStateMixin {
  late GameAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GameAddModel());
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: FlutterFlowDropDown<String>(
                              ...
                              options: const ['Юлия Харт', 'Максим Московец'],
                              onChanged: (val) =>
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await GameTable().insert({
                                    'nameGame': _model.yourNameController1.text,
                                    'author': _model.dropDownValue,
