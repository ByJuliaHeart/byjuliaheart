...
import 'block_date_game_copy_model.dart';
export 'block_date_game_copy_model.dart';

class BlockDateGameCopyWidget extends StatefulWidget {
  const BlockDateGameCopyWidget({
    super.key,
    required this.name,
  ...
  @override
  State<BlockDateGameCopyWidget> createState() =>
      _BlockDateGameCopyWidgetState();
}

class _BlockDateGameCopyWidgetState extends State<BlockDateGameCopyWidget> {
  late BlockDateGameCopyModel _model;
