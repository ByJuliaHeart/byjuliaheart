            ...
            Expanded(
              child: Align(
                ...
                child: Container(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(5.0, 24.0, 5.0, 24.0),
                    child: Column(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            if (FFAppState().roleUsers.contains('Admin') ||
                                FFAppState().roleUsers.contains('Gamrpractice'))
                              ...
                              Padding(
                                ...
                                child: FutureBuilder<List<GameFieldRow>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<GameFieldRow> timerGameFieldRowList =
                                        snapshot.data!;
                                    final timerGameFieldRow =
                                        timerGameFieldRowList.isNotEmpty
                                            ? timerGameFieldRowList.first
                                            : null;
                                    return FlutterFlowTimer(
                                      initialTime: functions.timer()!,
