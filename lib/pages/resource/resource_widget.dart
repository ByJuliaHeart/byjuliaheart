                              ...
                              child: TabBarView(
                                ...
                                children: [
                                  FutureBuilder<List<ResourseRow>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return ListView.separated(
                                        ...
                                        itemCount:
                                            resourcemyResourseRowList.length,
                                  ...
                                  FutureBuilder<List<AnktetsRow>>(
                                    future: _model
                                        .ankets(
                                      requestFn: () => AnktetsTable().queryRows(
                                        queryFn: (q) => q
                                            .eq(
                                              'user_id',
                                              currentUserUid,
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<AnktetsRow> anketsAnktetsRowList =
                                          snapshot.data!;
                                      return ListView.separated(
                                        padding: const EdgeInsets.fromLTRB(
                                          0,
                                        ...
                                        shrinkWrap: true,
                                        scrollDirection: Axis.vertical,
                                        itemCount: anketsAnktetsRowList.length,
                                        separatorBuilder: (_, __) =>
                                            const SizedBox(height: 8.0),
                                        itemBuilder: (context, anketsIndex) {
                                          final anketsAnktetsRow =
                                              anketsAnktetsRowList[anketsIndex];
                                          return Container(
                                            width: double.infinity,
                                            constraints: const BoxConstraints(
                                              maxWidth: 570.0,
