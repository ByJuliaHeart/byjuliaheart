                        ...
                        if ((MediaQuery.sizeOf(context).width <
                          ...
                          return FutureBuilder<List<GameFieldRow>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              if (!snapshot.hasData) {
                                return const BlockDateGameShimerWidget();
                              }
                                        ...
                                        return ListView.separated(
                                          ...
                                          itemBuilder:
                                            ...
                                            return BlockDateGameCopyWidget(
                                              ...
                                              name: listViewGameFieldRow
                                                  .nameGame!,
                                              description: listViewGameFieldRow
                                                  .discription!,
                                              author:
                                                  listViewGameFieldRow.author!,
                                              img: listViewGameFieldRow.img!,
                                              buttonname: 'Зарегистрироваться',
                                              gameid:
                                                  listViewGameFieldRow.gameId!,
                                              date: listViewGameFieldRow
                                                  .dateGame!
                                                  .toString(),
                                              gamefieldid:
                                                  listViewGameFieldRow.id,
                                              dateTime:
                                                  '${listViewGameFieldRow.hhTime}${listViewGameFieldRow.mmTime}',
                                              idmembergame: listViewGameFieldRow
                                                  .idMemberGame,
                                            );
                                          },
                                        );
