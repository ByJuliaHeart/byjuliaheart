                                                                  ...
                                                                  children: [
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        valueOrDefault<
                                                                            String>(
                                                                          columnUsersRow.id == currentUserUid
                                                                              ? 'Мои карты'
                                                                              : columnUsersRow.name,
                                                                          '-',
                                                                        ),
                                                                    ...
                                                                    FutureBuilder<
                                                                        List<
                                                                            CardsLiveGameRow>>(
                                                                      future: (_model
                                                                              .requestCompleter2 ??= Completer<List<CardsLiveGameRow>>()
                                                                            ..complete(CardsLiveGameTable().queryRows(
                                                                              queryFn: (q) => q.eq(
                                                                                'id_game_field',
                                                                                widget.gamefield,
                                                                              ),
                                                                        ...
                                                                        return SingleChildScrollView(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            mainAxisSize:
                                                                                MainAxisSize.max,
                                                                            children:
                                                                                List.generate(userGameCardsCardsLiveGameRowList.length, (userGameCardsIndex) {
                                                                              final userGameCardsCardsLiveGameRow = userGameCardsCardsLiveGameRowList[userGameCardsIndex];
                                                                              return Visibility(
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      setState(
                                                                        ...
                                                                        FFAppState().cardConfirm = _model
                                                                            .mycardQ![random_data.randomInteger(0,
                                                                                5)]
                                                                            .frontCard!;
                                                                      });
                                                                      _model.cards =
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return GestureDetector(
                                                                            ...
                                                                            child:
                                                                                Padding(
                                                                              padding: MediaQuery.viewInsetsOf(context),
                                                                              child: RandomCardWidget(
                                                                                img: FFAppState().cardConfirm,
                                                                              ),
                                                                            ),
                                                                          );
                                                                        },
