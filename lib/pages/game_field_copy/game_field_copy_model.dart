...
import 'dart:async';
import 'game_field_copy_widget.dart' show GameFieldCopyWidget;
import 'package:stop_watch_timer/stop_watch_timer.dart';
import 'package:flutter/material.dart';

class GameFieldCopyModel extends FlutterFlowModel<GameFieldCopyWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  Completer<List<GameFieldRow>>? requestCompleter1;
  Completer<List<CardsLiveGameRow>>? requestCompleter2;
  // Stores action output result for [Backend Call - Query Rows] action in gameFieldCopy widget.
